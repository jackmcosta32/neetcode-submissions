...
class KthLargest {
    ...
    constructor(k: number, nums: number[]) {
        ...
        console.log(
            `Initial heap before pop minVal = ${this.heap.minValue}, k = ${this.k}, size = ${this.heap.size}`,
            this.heap.heap
        )
        ...
        console.log(
            `Initial heap minVal = ${this.heap.minValue}, k = ${this.k}, size = ${this.heap.size}`,
            this.heap.heap
        )
    }
    ...
    add(val: number): number {
        console.log(
            `Adding val = ${val}, minVal = ${this.heap.minValue}, k = ${this.k}, size = ${this.heap.size}`,
            this.heap.heap
        )
